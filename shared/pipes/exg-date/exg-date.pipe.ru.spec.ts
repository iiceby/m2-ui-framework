...
describe('ExgDatePipe (ru) tests', () => {
    ...
    beforeEach(() => {
        ...
        const translateServiceStub = { getCurrentLang() { return ExgCultureEnum.Russian; } };
    ...
    it('Should show long date in specified format', () => {
        ...
        expect(element.textContent).toBe('27.11.2014');
    });
    ...
    it('Should show short date in specified format', () => {
        ...
        expect(element.textContent).toBe('27.05.2014');
    });
    ...
    it('Should show epoch date in specified format', () => {
        ...
        expect(element.textContent).toBe('24.05.2018');
    });
